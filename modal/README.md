...
verified an NVIDIA L4 with CUDA available under PyTorch 2.4.1 + CUDA 12.4.
Point-cloud inference still needs an end-to-end smoke test with a reconstructed
room `.ply`.
